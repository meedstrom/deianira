...
The package is not yet on (M)ELPA.
...
(use-package chain ;; dependency of deianira
  :straight (deianira :type git :host github :repo "meedstrom/chain"))
#+end_src
...
(package! chain :recipe (:host github :repo "meedstrom/chain"))
#+end_src
