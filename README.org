...
The keys we've chosen to represent presses of Control/Meta/Super must be listed doubly -- once in the komnad config, and once in the following Customizable variables.
