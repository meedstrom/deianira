...
You also saw the most important variable, =dei-homogenizing-winners=.  You'll want to customize it gradually over time.   Do you use ~C-x f~ or ~C-x C-f~ more?  It's hard to know when thinking about it, only experience will tell you.  But this is *absolutely key* to becoming comfortable.
...
I used to give =dei-homogenizing-winners= a default value, but I'm afraid someone will neglect to take ownership of the variable, so now the default is nil and deianira-mode refuses to start until it has a value.
