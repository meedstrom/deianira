...
An automatic [[https://github.com/abo-abo/hydra][hydra]]-based which-key banisher. The inverse of [[https://gitlab.com/jjzmajic/hercules.el][hercules.el]], which is "an auto-magical, which-key-based hydra banisher".  From Greek mythology, [[https://en.wikipedia.org/wiki/Deianira][Deianira]] was the wife of Hercules and the one who slew him.
